...
export default function CompanyProject() {
  ...
  const [companyInfo, setCompanyInfo] = useState({
    ...
    company_project_students_selected: [
      { label: "C++", value: 0 },
      { label: "Java", value: 1 },
    ],
  });
          ...
          <ListItem alignItems="flex-start">
                ...
                companyEdit.company_project_name === false ? (
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      setCompanyInput({
                        ...companyInput,
                        company_project_name: e.target.value,
                      });
                    }}
                    value={companyInput.company_project_name}
                  />
                )
              }
            />
            {companyEdit.company_project_name === false ? (
              <IconButton
                ...
                onClick={() => {
                  handleOpenEdit("company_project_name");
                }}>
                <EditTwoToneIcon />
              </IconButton>
            ) : (
              <>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleCancel("company_project_name");
                  }}>
                  <ClearRoundedIcon />
                </IconButton>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleSave("company_project_name");
                  }}>
          ...
          <ListItem alignItems="flex-start">
                ...
                companyEdit.company_project_description === false ? (
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      setCompanyInput({
                        ...companyInput,
                        company_project_description: e.target.value,
                      });
                    }}
                    value={companyInput.company_project_description}
                  />
                )
              }
            />
            {companyEdit.company_project_description === false ? (
              <IconButton
                className={classes.icon}
                onClick={() => {
                  handleOpenEdit("company_project_description");
                }}>
                <EditTwoToneIcon />
              </IconButton>
            ) : (
              <>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleCancel("company_project_description");
                  }}>
                  <ClearRoundedIcon />
                </IconButton>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleSave("company_project_description");
                  }}>
                  <CheckRoundedIcon style={{ color: "green" }} />
                </IconButton>
              </>
          ...
          <ListItem alignItems="flex-start">
            ...
            {companyEdit.company_project_skill === false ? (
              <IconButton
                className={classes.icon}
                onClick={() => {
                  handleOpenEdit("company_project_skill");
                }}>
                <EditTwoToneIcon />
              </IconButton>
            ) : (
              <>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleCancel("company_project_skill");
                  }}>
                  <ClearRoundedIcon />
                </IconButton>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleSave("company_project_skill");
                  }}>
                  <CheckRoundedIcon style={{ color: "green" }} />
                </IconButton>
              </>
          ...
          <ListItem alignItems="flex-start">
            ...
            <ListItemText
              ...
              secondary={
                companyEdit.company_project_deadline === false ? (
                  ...
                  <TextField
                    type="date"
                    name="company_project_deadline"
                    onChange={(e) => {
                      setCompanyInput({
                        ...companyInput,
                        company_project_deadline: e.target.value,
                      });
                    }}
                    value={companyInput.company_project_deadline}
                  />
                )
              }
            />
            {companyEdit.company_project_deadline === false ? (
              <IconButton
                className={classes.icon}
                onClick={() => {
                  handleOpenEdit("company_project_deadline");
                }}>
                <EditTwoToneIcon />
              </IconButton>
            ) : (
              <>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleCancel("company_project_deadline");
                  }}>
                  <ClearRoundedIcon />
                </IconButton>
                <IconButton
                  className={classes.icon}
                  onClick={() => {
                    handleSave("company_project_deadline");
                  }}>
                  <CheckRoundedIcon style={{ color: "green" }} />
                </IconButton>
              </>
          ...
          <ListItem alignItems="flex-start">
            ...
            <ListItemText
              ...
              secondary={
                <Box component={"span"}>
                  <div>
                    1. Being responsible with the student(s) <br />
