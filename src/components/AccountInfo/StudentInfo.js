...
const validate = values => {
        ...
        function NextClickButton(props) {
            return <button className="button-left button-red" onClick={props.onClick} type="submit" >{props.name}</button>;
          }
          
        function BackClickButton(props) {
            return <button className="button-left button-white"  onClick={props.onClick}>{props.name}</button>;
          }
...
function StudentInfo () {
  ...
  let buttonNext = (
    <NextClickButton name={"Continue"}  onClick={
       () => { 
        if(currentPage===1){
            //Check for errors
          ...
          if(formik.touched.firstName && formik.touched.lastName && formik.touched.studentEmail && formik.touched.studentId){
            setCurrentPage(2)
        }
  ...
  let buttonBack = (
    <BackClickButton  name={"Go Back"} onClick={  () => { 
        if(currentPage===2){
           setCurrentPage(1)
        }
     }}/>
                        ...
                        <div className="row">
                            <div className="column">
                                ...
                                <div className='form-control'>
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur} 
                                    value={formik.values.studentEmail} required /> 
                                    { formik.touched.studentEmail && formik.errors.studentEmail ? <div className='error'>{formik.errors.studentEmail}</div> : null}
                                </div>
                            ...
                            <div className="column">
                                <div className='form-control'>
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur} 
                                    value={formik.values.studentId} required/> 
                                    {formik.touched.studentId && formik.errors.studentId ? <div className='error'>{formik.errors.studentId}</div> : null}
                                </div>
                                ...
                                <div className='form-control'>
                                    ...
                                    <div className="date-picker">
                                        <DatePicker
                                            ...
                                            yearAriaLabel="Year"
                                        />
                                         {formik.touched.graduationDate && formik.errors.graduationDate ? <div className='error'>{formik.errors.graduationDate}</div> : null}
                                    </div>
                                ...
                                <div className='form-control'>
                                    ...
                                    <select name="major" className="list_of_all_majors form_input" id="major" onBlur={formik.handleBlur}  value={formik.values.major} onChange={formik.handleChange}>
                                ...
                                <div className="row">
                                    <div className="column-small">
                                        <div className='form-control'>
                                            ...
                                            <select name="degree" className="list_of_all_degrees form_input" id="degree" onBlur={formik.handleBlur}  value={formik.values.degree} onChange={formik.handleChange}>
                                    ...
                                    <div className="column-small">
                                        <div className='form-control'>
                                            ...
                                            <select name="degreeType" className="list_of_all_degrees_type form_input" id="degreeType" onBlur={formik.handleBlur}  value={formik.values.degreeType} onChange={formik.handleChange}>
