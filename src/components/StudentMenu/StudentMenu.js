...
export default function StudentMenu() {
    ...
    const MenuOptions = [
      {text:'Profile', url:'/dashboard/profile', icon:<AccountCircleRoundedIcon/>},
      {text:'My Projects', url:'/dashboard/projects', icon:<BusinessRoundedIcon/>},
      {text:'My Companies', url:'/dashboard/companies', icon:<StarsIcon/>},
      {text:'Search', url:'/dashboard/search', icon:<SearchRoundedIcon/>},
   ...
   return (
    <div className={classes.root}>
      ...
      <Drawer className={classes.drawer} variant="permanent" classes={{paper: classes.drawerPaper,}}>
        ...
        <Route path="/dashboard/projects" component={StudentProject}/>
      </main>
    </div>
    );
}
