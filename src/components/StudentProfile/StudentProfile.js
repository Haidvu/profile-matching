...
import {Typography,TextField,List,ListItem, Divider, ListItemText, ListItemIcon,IconButton } from "@material-ui/core";
...
export default function StudentProfile (){
  ...
  return (
    <div>
      <img alt="profile logo" className={classes.profileLogo} src={ProfileLogo}></img>
      <List>
